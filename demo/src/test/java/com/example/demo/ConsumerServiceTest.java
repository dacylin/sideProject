...
public class ConsumerServiceTest {
    ...
    public void testGetAllConsumers() {
        ...
        consumers.forEach(consumer -> {
            System.out.println("Consumer ID: " + consumer.getConsumersId());
            System.out.println("Name: " + consumer.getConsumersName());
            System.out.println("Email: " + consumer.getConsumersEmail());
            System.out.println("Phone: " + consumer.getConsumersPhone());
            System.out.println("Address: " + consumer.getConsumersAddress());
            System.out.println("-------------------------");
        });
    }
    ...
    public void testDeleteConsumer() {
        consumerService.deleteConsumer(9);
